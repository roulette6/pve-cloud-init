...
echo -e "\nThis script will create an ${YL}Fedora Cloud Base 42${NC} VM.\n"
...
cloud_img_path="/var/lib/vz/template/iso/Fedora-Cloud-Base-Generic-42-1.1.x86_64.img"
download_url="https://download.fedoraproject.org/pub/fedora/linux/releases/42/Cloud/x86_64/images/Fedora-Cloud-Base-Generic-42-1.1.x86_64.qcow2"
...
sed -i "s|todo_group|wheel|g" user-data
